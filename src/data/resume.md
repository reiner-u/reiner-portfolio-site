...
- **Noctus**: a Notion-style productivity app I'm currently building (Next.js, TypeScript, Supabase), aiming for an MVP by September 2026. The driving use case is a scheduler for a partner's academic scheduling workflow, my first time working with a managed database, OAuth, and Row Level Security.
